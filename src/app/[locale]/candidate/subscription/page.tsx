...
export default async function SubscriptionPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const tProps = {
    ...
    upgradeProfessionalLabel: t("upgradeProfessionalLabel"),
    upgradeCareerProLabel: t("upgradeCareerProLabel"),
    upgradeModalTitle: t("upgradeModalTitle"),
    upgradeModalDesc: t("upgradeModalDesc"),
    upgradeModalClose: t("upgradeModalClose"),
