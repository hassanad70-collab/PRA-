  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-3">
        <Button variant="outline" onClick={() => startTransition(() => signInWithOAuth("google"))} disabled={isPending} className="gap-2.5">
        ...
        <Button variant="outline" onClick={() => startTransition(() => signInWithOAuth("linkedin_oidc"))} disabled={isPending} className="gap-2.5">
          <svg viewBox="0 0 24 24" className="h-4 w-4 shrink-0 fill-[#0077B5]" aria-hidden="true">
